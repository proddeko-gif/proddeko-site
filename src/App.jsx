...
const JPN95 = {
  ...
  subtitle: "Face à la hausse du prix des engrais chimiques, aux tensions internationales et aux fragilités agricoles en RDC, PRODDEKO-Belgique porte un pilote de fertilisant naturel à base d'eau de mer pour renforcer les rendements, les revenus ruraux et la résilience des petits exploitants.",
    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 lg:px-8">
        ...
        <nav className="hidden items-center gap-3 lg:flex">
          ...
          <button type="button" onClick={() => setPage("donate")} className="rounded-full bg-orange-500 px-6 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-orange-600">Faire un don</button>
        </nav>
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
        <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            ...
            {/* Triple Sustain Impact Branding */}
            <div className="mt-6">
              <h1 className="text-4xl md:text-6xl font-black text-orange-500 leading-tight tracking-tight mb-2">
