...
export default function App(){
  ...
  <PageHero
    sourcil="Programmes"
    titre="Quatre programmes pour un triple impact"
    texte="PRODDEKO-Belgique – Triple Sustain Impact structure son action autour de quatre programmes complémentaires. Ils relient besoins territoriaux, renforcement des capacités, innovation et partenariats afin de produire des résultats sociaux, économiques et environnementaux durables."
  />

  <section nom de classe="py-20">
    <Envelopper>

      <Titre de la section
        sourcil="Nos domaines d’intervention"
        titre="Des programmes conçus à partir des réalités des territoires"
        texte="Chaque programme constitue un cadre d’intervention dans lequel peuvent être développés plusieurs projets, en Belgique comme en République démocratique du Congo."
      />

      <div nom de classe="mt-12 grid gap-8 lg:grid-cols-2">

        <div nom de classe="rounded-[2rem] border bg-white p-8 shadow-sm">
          <Gouttelettes nom de classe="h-10 w-10 text-orange-500" />
          <div nom de classe="mt-5 text-xs font-black uppercase tracking-[.25em] text-orange-600">
            Programme 01
          </div>
          <h2 nom de classe="mt-3 text-2xl font-black text-blue-950">
            Eau, agriculture & résilience climatique
          </h2>
          <p nom de classe="mt-4 leading-7 text-slate-600">
            Améliorer durablement l’accès à l’eau, renforcer l’agriculture familiale
            et développer la capacité des communautés à faire face aux effets du
            changement climatique.
          </p>

          <div nom de classe="mt-6 border-t pt-5">
            <div nom de classe="font-bold text-blue-950">Axes d’intervention</div>
            <p nom de classe="mt-2 leading-7 text-slate-600">
          ...
          <div nom de classe="mt-5 rounded-2xl bg-slate-50 p-5">
            <div nom de classe="text-sm font-black text-blue-950">Projet associé</div>
            <p nom de classe="mt-2 text-slate-600">
        ...
        <div nom de classe="rounded-[2rem] border bg-white p-8 shadow-sm">
          <Porte-documents affaires nom de classe="h-10 w-10 text-orange-500" />
          <div nom de classe="mt-5 text-xs font-black uppercase tracking-[.25em] text-orange-600">
            Programme 02
          </div>
          <h2 nom de classe="mt-3 text-2xl font-black text-blue-950">
          ...
          <div nom de classe="mt-5 rounded-2xl bg-slate-50 p-5">
            <div nom de classe="text-sm font-black text-blue-950">Initiatives associées</div>
            <p nom de classe="mt-2 text-slate-600">
        ...
        <div nom de classe="rounded-[2rem] border bg-white p-8 shadow-sm">
          <Utilisateurs nom de classe="h-10 w-10 text-orange-500" />
          <div nom de classe="mt-5 text-xs font-black uppercase tracking-[.25em] text-orange-600">
            Programme 03
          </div>
          <h2 nom de classe="mt-3 text-2xl font-black text-blue-950">
          ...
          <div nom de classe="mt-5 rounded-2xl bg-slate-50 p-5">
            <div nom de classe="text-sm font-black text-blue-950">Initiative associée</div>
            <p nom de classe="mt-2 text-slate-600">
              Les ponts du football de Bruxelles · Belgique.
            </p>
          </div>
        </div>

        <div nom de classe="rounded-[2rem] border bg-white p-8 shadow-sm">
          <Échelle nom de classe="h-10 w-10 text-orange-500" />
          <div nom de classe="mt-5 text-xs font-black uppercase tracking-[.25em] text-orange-600">
            Programme 04
          </div>
          <h2 nom de classe="mt-3 text-2xl font-black text-blue-950">
          ...
          <div nom de classe="mt-5 rounded-2xl bg-slate-50 p-5">
            <div nom de classe="text-sm font-black text-blue-950">Fonction transversale</div>
            <p nom de classe="mt-2 text-slate-600">
      ...
      <div nom de classe="mt-14 rounded-[2rem] bg-blue-950 p-8 text-white sm:p-10">
        <div nom de classe="max-w-3xl">
          <div nom de classe="text-xs font-black uppercase tracking-[.25em] text-orange-400">
            Une logique commune
          </div>

          <h2 nom de classe="mt-4 text-3xl font-black">
            Du programme au projet, du projet à l’impact
          </h2>

          <p nom de classe="mt-5 leading-8 text-slate-200">
            Les programmes définissent les orientations de long terme. Les projets
            traduisent ces orientations en interventions concrètes, avec des
            territoires, des bénéficiaires, des partenaires, des ressources et des
            résultats attendus clairement identifiés.
          </p>

          <button
            onClick={()=>aller("projets")}
            nom de classe="mt-7 inline-flex items-center gap-2 rounded-full bg-orange-500 px-6 py-3 font-black text-white transition hover:bg-orange-600"
          >
            Découvrir nos projets
            <ChevronRight nom de classe="h-5 w-5" />
          </button>
        </div>
      </div>
